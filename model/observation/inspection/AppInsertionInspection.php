...
class AppInsertionInspection
{
    ...
    public function InspectionInsert($data=array())
    {
        $id_reception = $this->InspectionSelectIdReception($data[1]);

        $requete = $this->dbaseprivateLite->prepare("INSERT into inspection (date_inspection, kilometrage_inspection, num_p_d_inspection, nom_p_d_inspection, quantite_p_d_inspection, num_com_inspection, resultat_inspection, id_reception) VALUES (:date_inspection, :kilometrage_inspection, :num_p_d_inspection, :nom_p_d_inspection, :quantite_p_d_inspection, :num_com_inspection, :resultat_inspection, :id_reception)");
